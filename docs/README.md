...
> Backend status note (March 2026): this document is partially legacy.  
> Current deploy map is maintained in `docs/ACTIVE_BACKEND_MAP.md` (Firebase-first runtime, `firebase_backend/functions` as active Functions source).
