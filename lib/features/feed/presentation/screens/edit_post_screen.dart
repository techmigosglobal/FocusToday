...
/// Edit Post Screen
/// Screen for admins to edit pending posts before approval
  ...
  Future<void> _saveChanges() async {
    ...
    if (!_hasUnsavedChanges) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text(l.noChangesToSave)));
      return;
    }
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(l.postUpdatedSuccessfully),
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('${l.errorUpdatingPost}: $e'),
              ...
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      if (widget.post.editCount > 0)
                        Container(
                          padding: const EdgeInsets.all(8),
                          margin: const EdgeInsets.only(bottom: 16),
                          decoration: BoxDecoration(
                            color: AppColors.infoOf(
                              context,
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                l.previouslyEditedTimes(widget.post.editCount),
                                style: TextStyle(
                                  color: AppColors.infoOf(context),
                                  fontSize: 12,
                                ),
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        items: _categories.map((category) {
                          return DropdownMenuItem(
                            value: category,
                            child: Text(l.getCategoryName(category)),
                          );
                        }).toList(),
                        onChanged: (value) {
                          if (value != null) {
                          ...
                          child: _isSubmitting
                              ? Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${l.save} ${(_submitProgress * 100).clamp(0, 100).toStringAsFixed(0)}%',
                                    ),
                                  ],
                                )
                              : Text(l.saveChanges),
